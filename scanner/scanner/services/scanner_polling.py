...
from scanner.scanner.services.last_block_persister import LastBlockPersister
from scanner.scanner.services.scanner import Scanner
...
class ScannerPolling(Scanner):
    ...
    def polling(self):
        try:
            ...
            if int(self.last_block_number) - self.next_block_number > self.commitment_chain_length:
